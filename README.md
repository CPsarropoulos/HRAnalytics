...
the project constists of 2 notebooks:
 ...
 2. [HRAnalytics]([HRAnalytics.ipynb](https://nbviewer.org/github/CPsarropoulos/HRAnalytics/blob/master/HRAnalytics.ipynb)) which contains visualizations on the dataset, a K-means clustering example and a Logistic  
   regression example 
